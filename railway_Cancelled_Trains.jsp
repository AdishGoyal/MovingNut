...
<script>
			$(document).ready(function(){
				...
				var month=$("#date2").val();
				var year=$("#date3").val();
					var url="https://api.railwayapi.com/v2/cancelled/date/"+day+"-"+month+"-"+year+"/apikey/e8mf15q56w/"
					...
					for(var i=0;i<response.trains.length;i++)
					{
						...
						var type=response.trains[i].type;
						var dest_name=response.trains[i].dest.name;
						str +="<tr><td>"+i+"</td><td>"+t_number+"</td><td>"+t_name+"</td><td>"+type+"</td><td>"+dest_name+"</td></tr>";
					}
...
<body>
	<div class="alert alert-info"><center><b>Today's cancelled trains</b></center></div>
	<b>Date</b>
		<br>
		<div id="t3">
			<select id="date1">
